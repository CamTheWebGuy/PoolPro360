    ...
    return (
      <UncontrolledDropdown>
        ...
        <DropdownMenu className='dropdown-menu-arrow' right>
          ...
          <DropdownItem>Assign Order</DropdownItem>
          <DropdownItem>Edit Status</DropdownItem>
        </DropdownMenu>
      </UncontrolledDropdown>
    );
  };
              ...
              <ModalBody>
                ...
                <Row>
                  ...
                  <Col>
                    ...
                    {workOrders[infoModal.order].orderType === true ? (
                      <p>Yes</p>
                    ) : (
                      <p>No</p>
                    )}
                ...
                <Row>
                  <Col>
                    <Button className='btn-icon' color='primary' block>
                    ...
                    <Button className='btn-icon' color='success' block>
                      <span className='btn-inner--icon'>
            ...
            >
              ...
              <ModalBody>
                <Formik
                  ...
                  onSubmit={async data => {
                    setAddModal({ ...addModal, isLoading: true });
                    await createWorkOrder(data);
                    await getWorkOrders();
                    setAddModal({ isLoading: false, isOpen: false });
                  }}
                  render={({
                    handleSubmit,
                    handleChange,
                    ...
                    <Form onSubmit={handleSubmit}>
                      ...
                      <Row>
                        ...
                        <Col lg='8'>
                          <FormGroup>
                            <Label className='form-control-label'>
                              Order Description (May Be Sent To Customer):
                            </Label>
                            <Input
                              type='textarea'
                              name='description'
